...
if (isunix || ismac)
 ...
 up_dir   =['..',separator];
     ...
     link_lib     = {'rt','gfortran','fftw3','fftw3f','fftw3_threads'};
...
elseif ispc
 ...
 mex_obj_str = ['mex -c -DADE_TARGET_TYPE=ADE_PC_NORMAL -DADE_BLAS_IMPLEMENTATION=ADE_USE_BLAS_LIB -DOSC_HOST_LITTLE_ENDIAN CFLAGS="\$CFLAGS -std=c99" ',Cshared_search_path,c_2_obj_file{1},'.c ',Cshared_search_path,c_2_obj_file{2},'.cpp ',...
 ...
 if (isunix || ismac)
      mex_str = ['mex -DADE_TARGET_TYPE=ADE_PC_NORMAL ',mex_main_path,' ',mex_obj_path,obj_2_exec_file{1},'.',obj_extenstion,mex_obj_path,obj_2_exec_file{2},'.',obj_extenstion,...
