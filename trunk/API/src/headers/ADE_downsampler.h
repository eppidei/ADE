...
struct ADE_DOWNSAMPLER_S
{
    ...
    ADE_DOWNSAMP_CHOICE_T down_samp_type;
...
ADE_API_RET_T ADE_Downsampler_Init(ADE_DOWNSAMPLER_T **dp_downsampler,ADE_UINT32_T in_buff_len,ADE_UINT32_T downfact,
                                ADE_UINT32_T filter_order,ADE_FIR_IMP_CHOICE_T fir_type, ADE_IIR_IMP_CHOICE_T iir_type,
                                ADE_UINT32_T n_iir_sections,ADE_DOWNSAMP_CHOICE_T down_type);
