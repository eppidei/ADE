...
X_ERRCLASS(ADE_CLASS_SOURCES) \
X_ERRCLASS(ADE_CLASS_TESTBENCH) \
...
X_ERRMETHODS(ADE_METHOD_SetNoPowSlot) \
X_ERRMETHODS(ADE_METHOD_SetNoIndexes) \
X_ERRMETHODS(ADE_METHOD_SetTimeLeft) \
X_ERRMETHODS(ADE_METHOD_SetTimeRight) \
X_ERRMETHODS(ADE_METHOD_SetFftLen) \
X_ERRMETHODS(ADE_METHOD_SetExtractLen) \
X_ERRMETHODS(ADE_METHOD_SetGain) \
X_ERRMETHODS(ADE_METHOD_SetFc) \
X_ERRMETHODS(ADE_METHOD_SetFs) \
X_ERRMETHODS(ADE_METHOD_SetNoRows) \
X_ERRMETHODS(ADE_METHOD_SetNoCols) \
X_ERRMETHODS(ADE_METHOD_SetSourceType) \
X_ERRMETHODS(ADE_METHOD_CreateSocket) \
X_ERRMETHODS(ADE_METHOD_SetRemote) \
X_ERRMETHODS(ADE_METHOD_SetLocal) \
X_ERRMETHODS(ADE_METHOD_SendInternalBuff) \
X_ERRMETHODS(ADE_METHOD_SetInternalBuff) \
X_ERRMETHODS(ADE_METHOD_SendExternalBuff) \
X_ERRMETHODS(ADE_METHOD_SetExternalBuff) \
X_ERRMETHODS(ADE_METHOD_Connect) \
