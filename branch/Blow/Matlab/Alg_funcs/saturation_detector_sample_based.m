function  [nstate,eval_counter,eval_pow,eval_timer] =saturation_detector_sample_based(pstate,sample,running_pow_fast,running_pow_slow,pow_thresh_high,pow_thresh_low,sat_thresh,n_sat_thres,n_pow_thres,eval_time_init,...
