...
//ADE_API_RET_T ADE_Blas_level2_Elewise_Config(ADE_blas_level2_T* p_blas_l2,ADE_FLOATING_T *p_buff1,ADE_FLOATING_T *p_buff2)
//{
//    ADE_INT32_T k=0;
//    ADE_FLOATING_T alpha=1.0,beta=0.0;
//
