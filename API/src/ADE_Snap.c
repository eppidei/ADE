...
ADE_API_RET_T ADE_Snap_Init(ADE_SNAP_T **p_snap,ADE_UINT32_T buff_len,ADE_UINT32_T Fs_i,ADE_UINT32_T n_pow_slots_i,ADE_UINT32_T n_max_indexes_i,ADE_FLOATING_T time_left_i,ADE_FLOATING_T time_right_i,ADE_UINT32_T fft_len_i)
{
    ...
    ADE_CHECK_MEMALLOC(ADE_CLASS_SNAP,Init,pthis);
        ...
        for (i=0;i<p_this->n_max_indexes;i++)
        {
                ...
                ADE_CHECK_MEMALLOC(ADE_CLASS_SNAP,Init,pthis->dp_segments[i]);
        ...
        /****** spectrum allocation ********/
           ...
           p_this->dp_spectrum=(ADE_CPLX_T**)calloc(p_this->n_max_indexes,sizeof(ADE_CPLX_T*));
            ADE_CHECK_MEMALLOC(ADE_CLASS_SNAP,Init,pthis->dp_spectrum);
        ...
        /* To improve bisogna rendere coerente questo con il type FFT_R2C  */
            ...
            ADE_CHECK_MEMALLOC(ADE_CLASS_SNAP,Init,pthis->dp_spectrum[i]);
        ...
        ADE_CHECK_MEMALLOC(ADE_CLASS_SNAP,Init,pthis->p_percent_pow);

        /** percent bool allocation **/

        p_this->p_snaps=malloc( p_this->n_max_indexes*sizeof(ADE_BOOL_T));
        ADE_CHECK_MEMALLOC(ADE_CLASS_SNAP,Init,pthis->p_snaps);
        ...
        ADE_CHECK_MEMALLOC(ADE_CLASS_SNAP,Init,pthis->dp_blas_l1_pow_spect_whole);
        ...
        ADE_CHECK_MEMALLOC(ADE_CLASS_SNAP,Init,pthis->dp_blas_l1_pow_spect_band);

        for (i=0;i<p_this->n_max_indexes;i++)
        {
                blas1_ret_specb=ADE_Blas_level1_Init(&(p_this->dp_blas_l1_pow_spect_band[i]),ADE_CPLX);
                ADE_CHECK_ADERETVAL(ADE_CLASS_SNAP,Init,blas1_ret_specb);
        }
...
//        {
       ...
       // }
        ...
        ADE_CHECK_ADERETVAL(ADE_CLASS_SNAP,Init,blas2_ret_tgk1);

        blas2_ret_tgk2=ADE_Blas_level2_Init(&(p_this->p_blas_l2_tgk2),ADE_REAL);
        ADE_CHECK_ADERETVAL(ADE_CLASS_SNAP,Init,blas2_ret_tgk2);


        /***************** ALLOC CC IIR *********************/
        iir_ret=ADE_Iir_Init(&(p_this->p_iir),iir_n_sos,buff_len,ADE_IIR_TRASP_II_B);
        ADE_CHECK_ADERETVAL(ADE_CLASS_SNAP,Init,iir_ret);
...
ADE_CHECK_INPUTPOINTER(ADE_CLASS_SNAP,Configure,p_snap);
 ...
 double  *p_max_array=NULL;
    ...
    {
        ADE_PRINT_ERRORS(ADE_ERROR,ADE_RETCHECKS,ADE_CLASS_SNAP,Configure,p_max_array,"%p",(FILE*)ADE_STD_STREAM);
        return ADE_RET_ERROR;
    }
...
ADE_CHECK_INPUTPOINTER(ADE_CLASS_SNAP,Configure,p_snap->p_in);
...
/*y = x(2:L-1).^2-x(1:L-2).*x(3:L);*/
    ...
    ADE_CHECK_ADERETVAL(ADE_CLASS_SNAP,Configure,ret_elew_cfg);
...
for(fft_idx=0;fft_idx<p_snap->n_max_indexes;fft_idx++)
{
    ...
    ADE_CHECK_ADERETVAL(ADE_CLASS_SNAP,Configure,ret_fft);
}
...
for(fft_idx=0;fft_idx<p_snap->n_max_indexes;fft_idx++)
{
    ...
    ADE_CHECK_ADERETVAL(ADE_CLASS_SNAP,Configure,ret_specw);
 ...
 for(fft_idx=0;fft_idx<p_snap->n_max_indexes;fft_idx++)
{
    ...
    ADE_CHECK_ADERETVAL(ADE_CLASS_SNAP,Configure,ret_specb);
...
ADE_API_RET_T ADE_Snap_Step(ADE_SNAP_T *p_snap)
{
    ...
    ADE_CHECK_ADERETVAL(ADE_CLASS_SNAP,Step,ret_memset);

    ret_b1= ADE_Blas_level1_axpy(p_snap->p_blas_l1_threshold);
    ADE_CHECK_ADERETVAL(ADE_CLASS_SNAP,Step,ret_b1);

    /*  detect_energy_threshold(actual_frame,thres); */

    ret_thresh =  ADE_Snap_ThresholdDetection(p_snap);
    ADE_CHECK_ADERETVAL(ADE_CLASS_SNAP,Step,ret_thresh);

    ret_Xrms2 = ADE_Snap_Xrms2(p_snap);
    ADE_CHECK_ADERETVAL(ADE_CLASS_SNAP,Step,ret_Xrms2);

    ret_max =  ADE_Snap_find_local_max(p_snap);
    ADE_CHECK_ADERETVAL(ADE_CLASS_SNAP,Step,ret_max);

    ret_events = ADE_Snap_extract_events(p_snap);
    ADE_CHECK_ADERETVAL(ADE_CLASS_SNAP,Step,ret_events);

    ret_recog = ADE_Snap_snap_recognition(p_snap);
    ADE_CHECK_ADERETVAL(ADE_CLASS_SNAP,Step,ret_recog);

    ret_detect=ADE_Snap_snap_detector(p_snap);
    ADE_CHECK_ADERETVAL(ADE_CLASS_SNAP,Step,ret_detect);
...
ADE_API_RET_T ADE_Snap_SetInBuff(ADE_SNAP_T *p_snap, ADE_FLOATING_T *p_buff)
{
    ...
    ADE_CHECK_INPUTPOINTER(ADE_CLASS_SNAP,SetInBuff,p_snap);
    ADE_CHECK_INPUTPOINTER(ADE_CLASS_SNAP,SetInBuff,p_buff);
...
static ADE_API_RET_T ADE_Snap_TeagerKaiser(ADE_SNAP_T *p_snap)
{
    ...
    ADE_CHECK_INPUTPOINTER(ADE_CLASS_SNAP,TeagerKaiser,p_snap);

    ret=ADE_Blas_level2_Elewise(p_snap->p_blas_l2_tgk1);
    ADE_CHECK_ADERETVAL(ADE_CLASS_SNAP,TeagerKaiser,ret);
...
static ADE_API_RET_T ADE_Snap_ThresholdDetection(ADE_SNAP_T *p_snap)
{
    ...
    ADE_CHECK_INPUTPOINTER(ADE_CLASS_SNAP,ThresholdDetection,p_snap);

    ret=ADE_Snap_TeagerKaiser(p_snap);
    ADE_CHECK_ADERETVAL(ADE_CLASS_SNAP,ThresholdDetection,ret);
...
static ADE_API_RET_T ADE_Snap_Xrms2(ADE_SNAP_T *p_snap)
{
    ...
    ADE_CHECK_INPUTPOINTER(ADE_CLASS_SNAP,Xrms2,p_snap);
...
static ADE_API_RET_T ADE_Snap_find_local_max(ADE_SNAP_T *p_snap)
{
   ...
   ADE_CHECK_INPUTPOINTER(ADE_CLASS_SNAP,find_local_max,p_snap);
...
FILE *p_stream=ADE_STDERR_STREAM;
 ...
 ADE_CHECK_INPUTPOINTER(ADE_CLASS_SNAP,extract_events,p_snap);
